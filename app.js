    ...
    React.createElement('div', { className: 'max-w-7xl mx-auto' },
      ...
      React.createElement('div', { className: 'grid lg:grid-cols-3 gap-6' },
        ...
        React.createElement('div', { className: `${showQA ? 'lg:col-span-1' : 'lg:col-span-2'} bg-white rounded-lg shadow-sm border border-slate-200 p-6` },
          ...
          React.createElement('div', { className: `w-full p-4 border border-slate-300 rounded-lg bg-slate-50 overflow-auto ${showQA ? 'h-80' : showHistory ? 'h-96' : 'h-[32rem]'}` }, output ? React.createElement('pre', { className: 'text-slate-900 whitespace-pre-wrap text-sm font-mono leading-relaxed' }, output) : React.createElement('div', { className: 'flex items-center justify-center h-full' }, React.createElement('p', { className: 'text-slate-400 text-sm' }, '优化后的提示词将显示在这里...')))
        )
      ),
